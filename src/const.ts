...
// Flash power-on related registers and bits needed for ECO6/ECO7 (Rev 301/302)
export const ESP32P4_EFUSE_RD_REPEAT_DATA1_REG = ESP32P4_BASEFUSEADDR + 0x034;
export const ESP32P4_EFUSE_DOWNLOAD_MODE_XPD_ON_MASK = 1 << 16;
...
// EFUSE Block addresses for chip revision detection
export const ESP32_APB_CTL_DATE_ADDR = 0x60000078;
...
// ESP32-C3 specific EFUSE registers
export const ESP32C3_EFUSE_RD_MAC_SPI_SYS_3_REG = ESP32C3_BASEFUSEADDR + 0x04c;
export const ESP32C3_EFUSE_RD_MAC_SPI_SYS_5_REG = ESP32C3_BASEFUSEADDR + 0x054;

// ESP32-C5 specific registers for baudrate adjustment
export const ESP32C5_UART_CLKDIV_REG = 0x60000014;
export const ESP32C5_PCR_SYSCLK_CONF_REG = 0x60096110;
export const ESP32C5_PCR_SYSCLK_XTAL_FREQ_V = 0x7f;
export const ESP32C5_PCR_SYSCLK_XTAL_FREQ_S = 24;

// UART device buffer number registers for USB mode detection
export const ESP32S2_UARTDEV_BUF_NO = ESP32S2_UART_DATE_REG_ADDR & 0xfffff000;
export const ESP32S2_UARTDEV_BUF_NO_USB_OTG = 3;

export const ESP32S3_UARTDEV_BUF_NO = ESP32S3_UART_DATE_REG_ADDR & 0xfffff000;
export const ESP32S3_UARTDEV_BUF_NO_USB_OTG = 3;
export const ESP32S3_UARTDEV_BUF_NO_USB_JTAG_SERIAL = 4;

export const ESP32C3_UARTDEV_BUF_NO_USB_JTAG_SERIAL = 3;
export const ESP32C3_BUF_UART_NO_OFFSET = 0;

export const ESP32C5_UARTDEV_BUF_NO = 0x500ca000;
export const ESP32C5_UARTDEV_BUF_NO_USB_JTAG_SERIAL = 3;

export const ESP32C6_UARTDEV_BUF_NO = 0x500ca000;
export const ESP32C6_UARTDEV_BUF_NO_USB_JTAG_SERIAL = 3;

export const ESP32C61_UARTDEV_BUF_NO_REV_LE2 = 0x600ca000;
export const ESP32C61_UARTDEV_BUF_NO_REV_GT2 = 0x500ca000;
export const ESP32C61_UARTDEV_BUF_NO_USB_JTAG_SERIAL_REV_LE2 = 3;
export const ESP32C61_UARTDEV_BUF_NO_USB_JTAG_SERIAL_REV_GT2 = 3;

export const ESP32H2_UARTDEV_BUF_NO = 0x600ca000;
export const ESP32H2_UARTDEV_BUF_NO_USB_JTAG_SERIAL = 3;

export const ESP32H4_UARTDEV_BUF_NO = 0x60012000;
export const ESP32H4_UARTDEV_BUF_NO_USB_JTAG_SERIAL = 3;

export const ESP32P4_UARTDEV_BUF_NO_REV0 = 0x500ca000;
export const ESP32P4_UARTDEV_BUF_NO_REV300 = 0x500ca000;
export const ESP32P4_UARTDEV_BUF_NO_USB_OTG = 2;
export const ESP32P4_UARTDEV_BUF_NO_USB_JTAG_SERIAL = 3;
